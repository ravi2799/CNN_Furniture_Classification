...
def main():
    ...
    history = open(r'C:\Users\ra_saval\Desktop\fulhas\checkpoints\history.csv','w')
...
#         val_loss = train(model, val_loader, criterion, optimizer, epoch)
        ...
        save_checkpoint({'epoch': epoch,'state_dict': model.state_dict(),
            'optimizer' : optimizer.state_dict(),'loss' : train_loss}, r'C:\Users\ra_saval\Desktop\fulhas\checkpoints\checkpoint_{}.ckpt'.format(epoch))
    history.close()
